    ...
    $.ajax(
	    ...
	    <div id="service" class="service-business-area pt-90 pb-60 fix" style="padding-top: 30px;">
		    <div class="container">
                <div class="row">
                	<div class="col-md-12 text-center">                
                		<h1 style="font-family: 'Montserrat', sans-serif;">Tarifa Normal</h1>
					</div>
				</div>
            </div>     
                    ...
                    <div class="formularioRegistro register">
						...
						<hr>
                            <div class="doublemyinput">
                                ...
                                <select name="chatteecountry" onchange="check($(this).val(),24);">
                    ...
                    <div class="col-lg-6 col-md-8" >
		                <div class="feature-image-content" >
                            <div class="about-image wow fadeInLeft" data-wow-duration="2s" data-wow-delay=".3s">
                                <img src="img/banner/15.png" alt="Balboa Telecom" class="floatright">
                            </div>
		                </div>
		            </div>                  	
                </div><!--registerCont-->
